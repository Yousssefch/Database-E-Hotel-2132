    ...
    <div className="navbar-container ">
      <div className="navbar min-h-screen ">
        ...
        <nav className="navbar-menu">
          <a href="/homepage" className="navbar-item">
            <svg
          ...
          <a href="/myreservations" className="navbar-item">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <a href="/myrentings" className="navbar-item">
            ...
            <span className="navbar-text">My Rentings</span>
          </a>

          {isEmployee && (
            <>
              <a href="/addhotel" className="navbar-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                ...
                <span className="navbar-text">Add Hotel</span>
              </a>

              <a href="/addroom" className="navbar-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                ...
                <span className="navbar-text">Add Room</span>
              </a>

              <a href="/archive" className="navbar-item">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  ...
                  viewBox="0 0 16 16"
                >
                  <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1v7.5a2.5 2.5 0 0 1-2.5 2.5h-9A2.5 2.5 0 0 1 1 12.5V5a1 1 0 0 1-1-1zm2 3v7.5A1.5 1.5 0 0 0 3.5 16h9a1.5 1.5 0 0 0 1.5-1.5V5zm3-4h6a1 1 0 0 1 1 1v2H0V2a1 1 0 0 1 1-1z"/>
                </svg>
                <span className="navbar-text">Archives</span>
              </a>
